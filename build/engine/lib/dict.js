...
exports.insertWildcardMatching = exports.toRegexPattern = exports.jisKanji = void 0;
...
const toRegexPattern = (string) => {
    ...
    _str = _str
        ...
        .replace(/莵|菟/g, '(莵|菟)')
        .replace(/市|巿/g, '(市|巿)');
    _str = (0, exports.jisKanji)(_str);
    return _str;
};
exports.toRegexPattern = toRegexPattern;
const insertWildcardMatching = (string) => {
    return string.replace(/(?<!\[[^\]]*)([一-龯ぁ-んァ-ン])(?!\?)/g, '($1|\\?)');
};
exports.insertWildcardMatching = insertWildcardMatching;
