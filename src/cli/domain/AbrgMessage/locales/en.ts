...
const messages: Record<AbrgMessage, string> = {
  ...
  [AbrgMessage.APPLICATION_DESC]: "Address Base Registry Geocoder provided by Japan Digital Agency",
  ...
  [AbrgMessage.START_DOWNLOADING_NEW_DATASET]: 'Start downloading the new dataset',
  [AbrgMessage.EXTRACTING_THE_DATA]: 'Extracting the data...',
  [AbrgMessage.LOADING_INTO_DATABASE]: 'Loading into the database...',
  [AbrgMessage.NEW_DATASET_IS_AVAILABLE]: "New dataset has been found. Please update the local dataset using `abrg download`.",
  [AbrgMessage.DATA_DOWNLOAD_ERROR]: "Failed to download the dataset",
  [AbrgMessage.CANNOT_FIND_THE_SPECIFIED_RESOURCE]: "Can not find the specified resource",
  [AbrgMessage.DOWNLOADED_DATA_DOES_NOT_CONTAIN_THE_RESOURCE_CSV]: "Specified resource does not contain the data csv file",
