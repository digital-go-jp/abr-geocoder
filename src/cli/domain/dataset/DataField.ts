export class DataField {
  ...
  setValue(value: string): DataField {
  ...
  static readonly BASIC_RSDT_DIV = new DataField('基礎番号・住居番号区分', 'basic_rsdt_div');
  ...
  static readonly CHOME_NAME_KANA = new DataField('丁目名_カナ', 'chome_name_kana');
  static readonly CHOME_NAME_NUMBER = new DataField('丁目名_数字', 'chome_name_number');
  static readonly CITY_NAME = new DataField('市区町村名', 'city_name');
  static readonly CITY_NAME_KANA = new DataField('市区町村名_カナ', 'city_name_kana');
  static readonly CITY_NAME_ROMA = new DataField('市区町村名_英字', 'city_name_roma');
  static readonly COUNTRY_NAME = new DataField('郡名', 'country_name');
  static readonly COUNTRY_NAME_KANA = new DataField('郡名_カナ', 'country_name_kana');
  static readonly COUNTRY_NAME_ROMA = new DataField('郡名_英字', 'country_name_roma');
  static readonly EFCT_DATE = new DataField('効力発生日', 'efct_date');
  static readonly KOAZA_ALT_NAME_FLG = new DataField('小字名_通称フラグ', 'koaza_alt_name_flg');
  static readonly KOAZA_FRN_LTRS_FLG = new DataField('小字名_電子国土基本図外字', 'koaza_frn_ltrs_flg');
  static readonly KOAZA_NAME = new DataField('小字名', 'koaza_name');
  static readonly KOAZA_NAME_KANA = new DataField('小字名_カナ', 'koaza_name_kana');
  static readonly KOAZA_NAME_ROMA = new DataField('小字名_英字', 'koaza_name_roma');
  ...
  static readonly OAZA_FRN_LTRS_FLG = new DataField('大字・町名_電子国土基本図外字', 'oaza_frn_ltrs_flg');
  static readonly OAZA_TOWN_ALT_NAME_FLG = new DataField('大字・町名_通称フラグ', 'oaza_town_alt_name_flg');
  static readonly OAZA_TOWN_NAME = new DataField('大字・町名', 'oaza_town_name');
  static readonly OAZA_TOWN_NAME_KANA = new DataField('大字・町名_カナ', 'oaza_town_name_kana');
  static readonly OAZA_TOWN_NAME_ROMA = new DataField('大字・町名_英字', 'oaza_town_name_roma');
  static readonly OD_CITY_NAME = new DataField('政令市区名', 'od_city_name');
  static readonly OD_CITY_NAME_KANA = new DataField('政令市区名_カナ', 'od_city_name_kana');
  static readonly OD_CITY_NAME_ROMA = new DataField('政令市区名_英字', 'od_city_name_roma');
  static readonly POST_CODE = new DataField('郵便番号', 'post_code');
  static readonly PREF_NAME = new DataField('都道府県名', 'pref_name');
  static readonly PREF_NAME_KANA = new DataField('都道府県名_カナ', 'pref_name_kana');
  static readonly PREF_NAME_ROMA = new DataField('都道府県名_英字', 'pref_name_roma');
  ...
  static readonly RSDT_ADDR_FLG = new DataField('住居表示フラグ', 'rsdt_addr_flg');
  static readonly RSDT_ADDR_MTD_CODE = new DataField('住居表示方式コード', 'rsdt_addr_mtd_code');
  ...
  static readonly REP_PNT_SRID = new DataField('代表点_座標参照系', 'rep_pnt_srid');
  ...
  static toDataField(csvFieldName: string): DataField {
    ...
    csvFieldName = csvFieldName.toUpperCase();
